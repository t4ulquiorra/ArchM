...
object Updater {
    ...
    private const val StableReleaseBaseUrl = "https://github.com/t4ulquiorra/ArchM/releases"
    private const val CanaryReleaseBaseUrl =
        "https://github.com/t4ulquiorra/ArchM/releases"
    private const val CanaryWorkflowRunsUrl =
        "https://api.github.com/repos/t4ulquiorra/ArchM/actions/workflows/release.yml/runs" +
    ...
    private fun workflowArtifactDownloadUrl(): String {
        val artifactUrl =
            "https://nightly.link/t4ulquiorra/ArchM/workflows/release/main/${workflowArtifactName()}"
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/t4ulquiorra/ArchM/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "ArchM")
    ...
    suspend fun getCommitHistory(
        ...
        runCatchingCancellable {
            ...
            val response =
                client
                    .get("https://api.github.com/repos/t4ulquiorra/ArchM/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
