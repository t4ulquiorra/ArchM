...
package com.archm.player.listentogether
...
import com.archm.player.constants.ListenTogetherAutoApprovalKey
import com.archm.player.constants.ListenTogetherIsHostKey
import com.archm.player.constants.ListenTogetherRoomCodeKey
import com.archm.player.constants.ListenTogetherServerUrlKey
import com.archm.player.constants.ListenTogetherSessionTimestampKey
import com.archm.player.constants.ListenTogetherSessionTokenKey
import com.archm.player.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.archm.player.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.archm.player.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.archm.player.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.archm.player.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.archm.player.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.archm.player.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
