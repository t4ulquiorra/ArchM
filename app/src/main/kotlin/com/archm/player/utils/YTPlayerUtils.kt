...
import com.archm.player.utils.PlaybackLogLevel
...
import com.archm.player.utils.cipher.CipherDeobfuscator
import com.archm.player.utils.YTPlayerUtils.MAIN_CLIENT
import com.archm.player.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.archm.player.utils.YTPlayerUtils.validateStatus
import com.archm.player.utils.potoken.PoTokenGenerator
import com.archm.player.utils.potoken.PoTokenResult
import com.archm.player.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: com.archm.player.constants.PlaybackEngine = com.archm.player.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == com.archm.player.constants.PlaybackEngine.POTOKEN || engine == com.archm.player.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == com.archm.player.constants.PlaybackEngine.BRAVEPIPE || engine == com.archm.player.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
