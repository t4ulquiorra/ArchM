...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "com.archm.player.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "com.archm.player.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "com.archm.player.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "com.archm.player.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
