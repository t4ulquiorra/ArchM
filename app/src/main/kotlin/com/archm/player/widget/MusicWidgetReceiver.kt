...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.archm.player.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.archm.player.widget.LIKE"
        const val ACTION_NEXT = "com.archm.player.widget.NEXT"
        const val ACTION_PREVIOUS = "com.archm.player.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.archm.player.widget.UPDATE_WIDGET"
    }
}
