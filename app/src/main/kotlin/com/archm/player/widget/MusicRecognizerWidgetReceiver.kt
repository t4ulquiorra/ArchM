...
package com.archm.player.widget
...
import com.archm.player.recognition.MusicRecognitionService
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.archm.player.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.archm.player.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.archm.player.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.archm.player.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.archm.player.widget.recognizer.RESET"
    }
}
