...
import com.archm.player.di.ApplicationScope
import com.archm.player.extensions.toEnum
import com.archm.player.extensions.toInetSocketAddress
import com.archm.player.utils.CrashHandler
import com.archm.player.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        com.archm.player.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[com.archm.player.constants.PlaybackEngineKey]
        com.archm.player.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) com.archm.player.constants.PlaybackEngine.valueOf(engineName)
            else com.archm.player.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { com.archm.player.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        com.archm.player.utils.lastfm.LastFM.initialize(
