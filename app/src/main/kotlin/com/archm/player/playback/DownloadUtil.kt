...
import com.archm.player.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, com.archm.player.constants.DownloadQualityKey, com.archm.player.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = com.archm.player.constants.AudioQuality.OPUS,
