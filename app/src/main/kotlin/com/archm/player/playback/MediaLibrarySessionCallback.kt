...
import com.archm.player.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(com.archm.player.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun com.archm.player.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
