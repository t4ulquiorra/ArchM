...
package com.archm.player.echomusic.updater
...
import com.archm.player.echomusic.updater.downloadmanager.UpdateDownloadWorker
import com.archm.player.echomusic.updater.downloadmanager.DownloadNotificationManager
...
import com.archm.player.ui.component.ChangelogItem
import com.archm.player.ui.component.leadingItemShape
import com.archm.player.ui.component.middleItemShape
import com.archm.player.ui.component.endItemShape
import com.archm.player.ui.component.detachedItemShape
import com.archm.player.ui.component.parseMarkdown
import com.archm.player.ui.component.endItemShape
import com.archm.player.ui.component.detachedItemShape
import com.archm.player.ui.component.AnimatedActionButton
import com.archm.player.ui.component.ExpressiveIconButton
import com.archm.player.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/t4ulquiorra/ArchM/releases/download/${currentStatus.version}/ArchM.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/t4ulquiorra/ArchM/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/t4ulquiorra/ArchM/releases/download/$tagWithPrefix/changelog.json")
