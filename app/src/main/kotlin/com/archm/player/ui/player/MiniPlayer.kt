...
import com.archm.player.playback.CastConnectionHandler
import com.archm.player.playback.PlayerConnection
import com.archm.player.ui.screens.settings.DarkMode
import com.archm.player.ui.component.GlassComponent
...
import com.archm.player.echomusic.isBluetoothHeadphoneConnected
...
fun MiniPlayer(
    ...
    val positionState = remember { mutableLongStateOf(position) }
    val durationState = remember { mutableLongStateOf(duration) }
    LaunchedEffect(position) { positionState.longValue = position }
    LaunchedEffect(duration) { durationState.longValue = duration }
    MiniPlayer(
