...
import com.archm.player.constants.MaxImageCacheSizeKey
...
import com.archm.player.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.archm.player.playback.ExoDownloadService::class.java,
                    false
                )
